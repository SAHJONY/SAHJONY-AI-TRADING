// POST /api/trading/autonomous — AI agent submits a trade signal
// GET  /api/trading/autonomous — engine status

import { NextRequest, NextResponse } from 'next/server'
import { brokerFetch, resolveCredentials, resolveAccountId } from '@/lib/trading/alpaca'
...
export async function POST(req: NextRequest) {
  try {
    ...
    const result = await brokerFetch(`/v1/trading/accounts/${id}/orders`, {
      method: 'POST',
