...
const individualPlans = [
 {
  ...
  price: '$99',
  period: '/month',
  description: 'Start trading with AI from $100. Perfect for individuals entering the markets.',
  minDeposit: '$100',
  features: [
   '1 AI Trading Agent',
   'Trade from $100',
 ...
 },
 {
  ...
  price: '$249',
  period: '/month',
  description: 'Multi-agent trading with real-money execution and advanced risk controls.',
  minDeposit: '$500',
  features: [
   '3 AI Trading Agents',
   'Trade from $500',
 ...
 },
 {
  ...
  price: '$499',
  period: '/month',
  description: 'Full multi-agent arsenal with institutional-grade tools for serious traders.',
  minDeposit: '$1,000',
  features: [
   '5 AI Trading Agents',
   'Trade from $1,000',
...
export default function PricingPage() {
 ...
 const activePlans = tab === 'individual' ? individualPlans : institutionalPlans
 ...
 const handleCheckout = async () => {
  ...
  try {
   const endpoints: Record<string, string> = {
    ...
    square: '/api/cashapp/create-payment',
   }
 ...
 const getPlanPrice = () => {
  const allPlans = [...individualPlans, ...institutionalPlans]
   ...
   <main className="container-custom py-8">
    ...
    <div className="text-center mb-12 animate-slide-up">
     ...
     <h1 className="text-5xl md:text-6xl font-display font-bold text-white tracking-tighter mb-4">
      AI Trading<br />
      <span className="gradient-text">From $99/Month</span>
     </h1>
     <p className="text-text-secondary text-lg font-light max-w-2xl mx-auto">
      Start trading from $100 with autonomous AI agents. Individual or institutional — deploy your edge in minutes.
     </p>
    </div>

    {/* Tab Switcher */}
    <div className="flex justify-center mb-10 animate-slide-up" style={{ animationDelay: '60ms' }}>
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-5 max-w-6xl mx-auto mb-12">
     {activePlans.map((plan, idx) => (
      ...
      >
       ...
       {'minDeposit' in plan && (
        <p className="text-[11px] text-primary font-medium mb-6 tracking-wide">
         Min. deposit: {(plan as typeof individualPlans[0]).minDeposit}
        </p>
       )}

       {!('minDeposit' in plan) && <div className="mb-6" />}
       ...
       <div className="flex items-center justify-between mb-8">
        <div>
         ...
         <p className="text-sm text-text-secondary font-light mt-1">
          {activePlans.find(p => p.id === selectedPlan)?.name} Plan · 7-day free trial
         </p>
        </div>
       ...
       <div className="p-4 rounded-2xl bg-accent/[0.03] border border-accent/10 mb-8">
        <div className="flex items-center gap-3">
         ...
         <p className="text-[12px] text-text-secondary">
          <span className="text-accent font-medium">$0 today.</span> Your 7-day free trial starts immediately. You'll be charged {getPlanPrice()}/month after trial ends.
         </p>
        </div>
       </div>
